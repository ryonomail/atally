...
class LargeDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $jobTemplates = [
            ...
            // 金融
            ['title' => '銀行システムエンジニア', 'major' => 'ITエンジニア【システム開発・SE・インフラ】', 'minor' => 'システムエンジニア（SE）', 'industry' => '金融・保険', 'salary_min' => 6000000, 'salary_max' => 10000000, 'app_type' => '中途', 'desc' => '大手銀行向けシステム開発・保守をお任せします。金融系の上流工程から携われるポジションです。'],
            ['title' => 'ファイナンシャルアナリスト', 'major' => '金融', 'minor' => 'アナリスト', 'industry' => '金融・保険', 'salary_min' => 7000000, 'salary_max' => 12000000, 'app_type' => '中途', 'desc' => '株式・債券の分析レポート作成、投資戦略の立案をお任せします。CFA資格保有者歓迎。'],

            // 新卒向け
            ['title' => '新卒エンジニア（育成枠）', 'major' => 'ITエンジニア【Web・モバイル・ゲーム】', 'minor' => 'Webエンジニア', 'industry' => 'IT・通信', 'salary_min' => 3000000, 'salary_max' => 4000000, 'app_type' => '新卒', 'desc' => '未経験・新卒歓迎！3ヶ月の充実した研修プログラムでエンジニアとしてのキャリアをスタートできます。'],
            ['title' => '総合職（新卒採用）', 'major' => '管理・事務', 'minor' => '経営企画', 'industry' => 'コンサルティング', 'salary_min' => 3500000, 'salary_max' => 4500000, 'app_type' => '新卒', 'desc' => '新卒総合職として、営業・企画・マーケティングなど様々な部門でのキャリアを築けます。'],
            ['title' => '営業職（新卒・第二新卒）', 'major' => '営業', 'minor' => '法人営業', 'industry' => 'IT・通信', 'salary_min' => 3200000, 'salary_max' => 5000000, 'app_type' => '中途・新卒', 'desc' => '新卒・第二新卒歓迎の法人営業ポジション。入社後の研修体制が充実しており、未経験から活躍できます。'],

            // 建設・不動産
            ['title' => '施工管理（建築）', 'major' => '建設・不動産', 'minor' => '施工管理（建築）', 'industry' => '不動産・建設', 'salary_min' => 4500000, 'salary_max' => 7000000, 'app_type' => '中途', 'desc' => '建築現場の施工管理をお任せします。大型プロジェクトに携わるチャンスがあります。二級建築士歓迎。'],
            ['title' => '不動産コンサルタント', 'major' => '建設・不動産', 'minor' => 'プロパティマネジメント', 'industry' => '不動産・建設', 'salary_min' => 5000000, 'salary_max' => 9000000, 'app_type' => '中途', 'desc' => '投資用不動産の提案・コンサルティングをお任せします。宅地建物取引士資格保有者優遇。'],

            // 販売・サービス
            ['title' => '店長候補（アパレル）', 'major' => '販売・サービス', 'minor' => '店長・店長候補', 'industry' => '小売・流通', 'salary_min' => 3500000, 'salary_max' => 5500000, 'app_type' => '中途・新卒', 'desc' => 'アパレルブランドの店長候補として、接客・スタッフ管理・売上管理を担っていただきます。'],
        ];
