            ...
            <footer style={{
                ...
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 'var(--space-xl)', marginBottom: 'var(--space-xl)' }}>
                        <div>
                            <div style={{ fontWeight: 700, fontSize: 'var(--font-size-base)', color: 'var(--color-navy)', marginBottom: 'var(--space-sm)', letterSpacing: '-0.02em' }}>Atally</div>
                            <p style={{ lineHeight: 1.8, margin: 0 }}>ぴったり合う仕事探し、はじめよう。</p>
                        </div>
                        <div>
                            <div style={{ fontWeight: 600, fontSize: 'var(--font-size-xs)', color: 'var(--color-navy)', marginBottom: 'var(--space-sm)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>求職者の方</div>
                            {[
                                { to: '/jobs', label: '求人を探す' },
                        ...
                        <div>
                            <div style={{ fontWeight: 600, fontSize: 'var(--font-size-xs)', color: 'var(--color-navy)', marginBottom: 'var(--space-sm)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>企業の方</div>
                            {[
                        ...
                        <div>
                            <div style={{ fontWeight: 600, fontSize: 'var(--font-size-xs)', color: 'var(--color-navy)', marginBottom: 'var(--space-sm)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>人材紹介会社の方</div>
                            {[
                        ...
                        <div>
                            <div style={{ fontWeight: 600, fontSize: 'var(--font-size-xs)', color: 'var(--color-navy)', marginBottom: 'var(--space-sm)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>サポート</div>
                            {[
                    ...
                    <div style={{ borderTop: '1px solid var(--color-divider)', paddingTop: 'var(--space-md)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 'var(--space-sm)' }}>
                        <span style={{ color: 'var(--color-text-muted)' }}>&copy; {new Date().getFullYear()} Atally</span>
